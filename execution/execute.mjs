...
var queryExclusionList = ['locationsFlat', 'iabCategoriesFlat', 'iabCategoriesFlatV2', 'flatSafetySegments', 'devicesFlat', 'searchFlatSegments', 'devices', 'locations', 'flatSegmentsV2'];
/**
